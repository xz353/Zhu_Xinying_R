...
lapply(diamonds[sapply(diamonds,is.numeric)],mean)#using the sapply function into every numeric column, then using lapply function to get the mean of every numeric column
